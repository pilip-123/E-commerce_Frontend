...
function iconSvg(type) {
  ...
  if (i.includes('triangle') || i.includes('warning') || i.includes('alert') || i.includes('exclamation')) {
  ...
  if (i.includes('clock') || i.includes('history') || i.includes('time') || i.includes('expire')) {
    return '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>';
  }
  if (i.includes('x-circle') || i.includes('xcircle') || i.includes('out-of-stock') || i.includes('outofstock')) {
